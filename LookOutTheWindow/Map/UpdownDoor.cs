...
public class UpdownDoor(MainScene scn, Sprite sprite, Sprite spriteFrozen)
{
    ...
    public void Update(GameWindow window, float dt)
    {
        ...
        // Y Axis Movement
        (bool isCollideWithTilemapY, BoundingBox? collideWithY) = scn.Tilemap.Intersects(window, Collider, checkUpdownDoors:false);
